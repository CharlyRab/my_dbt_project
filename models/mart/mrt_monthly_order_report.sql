...
LEFT JOIN {{ ref('int_sales_databaseu__user')}} AS user ON user.user_name = orders.user_name
...
COALESCE(jt.total_monthly_users_from_jawa_timur,0) AS total_monthly_user_from_jawa_timur,
